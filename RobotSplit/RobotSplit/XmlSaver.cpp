...
//		
//	//Enters the GameObjects to Xml documents
...
//	string	pY,pX;
//	pX=	modifyInt((int)Source->getPosition().getX());
//	pY=	modifyInt((int)Source->getPosition().getY());
//	//Allocates the GameObject and Position elements in the Xml document
...
//}
//void	XmlSaver::addLaser			(Laser *Source,xml_node<>* Parent)
//{
...
//	pX=	modifyInt((int)Source->getPosition().getX());
//	pY=	modifyInt((int)Source->getPosition().getY());
//	sX=	modifyInt((int)Source->getSize().getX());
//	sY=	modifyInt((int)Source->getSize().getY());
//	//Allocates the GameObject and Position elements in the Xml document
//		xml_node<> *Gameobject	=mDocument.allocate_node(node_element,"GameObject");
...
//}
//
//void	XmlSaver::addPlatform		(Platform *Source,xml_node<>* Parent)
//{
//	char	*temp;
//	//Starts converting the vector to strings
//	string	pY,pX,sX,sY;
...
//	//Allocates the GameObject and Position elements in the Xml document
//		xml_node<> *Gameobject	=mDocument.allocate_node(node_element,"GameObject");
//		xml_node<> *Type		=mDocument.allocate_node(node_element,"Type","\"Platform\"");
//		xml_node<> *Position	=mDocument.allocate_node(node_element,"Position");
//		xml_node<> *Size		=mDocument.allocate_node(node_element,"Size");
//	//Adds the x element into the Position element
//		temp	=new char[pX.length()+1];
